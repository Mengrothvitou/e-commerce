                ...
                <div className="container-fluid">
                    ...
                    <ul className="navbar-nav m-auto p-3 s-2 navbar-light">
                        ...
                        <ul className="dropdown-menu dropdown-menu-dark" aria-labelled="navbarDarkDropdownMenuLink">
                            <li><a style={textStyle} className="dropdown-item" onClick={clothes}>Clothes</a></li>
                            <li><a style={textStyle} className="dropdown-item" onClick={shoe}>Shoes</a></li>
                            <li><a style={textStyle} className="dropdown-item" onClick={books}>Books</a></li>
                            <li><a style={textStyle} className="dropdown-item" onClick={bag}>Bags</a></li>
                            <li><a style={textStyle} className="dropdown-item" onClick={cosmetic}>Cosmetics</a></li>
                            <li><a style={textStyle} className="dropdown-item" onClick={watch}>Watches</a></li>
                        </ul>
                        </li>
                        <li>
                    ...
                    <button style=
                    {{height:50,width:60, border:"none",background:"none",marginTop:3,marginRight:0,}}><PersonOutlinedIcon style={iconStyles} onClick={user}/></button>
                    <br></br>
                    <button  style={{height:50,width:60, border:"none",background:"none",marginTop:3,marginRight:0}}><FavoriteOutlinedIcon style={iconStyles} onClick={Favorite}/></button>
                    <br></br>
                    <button style={{height:50,width:60, border:"none",background:"none",marginTop:3,marginRight:0}}><ShoppingCartOutlinedIcon style={iconStyles} onClick={shop}/></button>
                    </div>
                </div>
